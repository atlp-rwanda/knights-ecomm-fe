...
function RegisterVendor() {
  ...
  return (
    <div className="min-h-[100vh] h-auto w-full flex items-center justify-center py-10 px-4  bg-transparent1">
      ...
      >
        <h1 className="min-w-[100%] text-black1 text-2xl font-medium">Register</h1>
        ...
        <button className="w-full min-h-[50px] flex items-center justify-center bg-primary text-white text-2xl font-medium mt-2">
