...
const Checkout = () => {
  ...
  return (
    <div className="flex w-full items-center justify-center flex-col">
      <div className="flex flex-col py-8 items-center justify-center w-full bg-[#CDCDCD]/50">
        <img src={knightsLogo} alt="Knights Store Logo" />
        <p className="text-[35px] font-medium">Checkout</p>
        <p className="text-sm">
      ...
      <div className="flex gap-4 py-[64px] w-full items-center justify-center">
